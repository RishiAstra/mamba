...
def _chunk_scan_fwd_kernel(
    ...
    stride_cb_head: tl.constexpr,
    stride_cb_csize_m: tl.constexpr,
    ...
    stride_C_seqlen: tl.constexpr,
    stride_C_head: tl.constexpr,
...
def _chunk_scan_fwd(
    ...
    # Allocates output.
    out = torch.empty(seqlen, nheads, headdim, device=x.device, dtype=x.dtype)
